...
The primary challenge of this project was managing **atmospheric noise** and **sensor jitter**. Barometric pressure fluctuates constantly; a simple "if altitude > 5" check would cause the LED to light up. 
